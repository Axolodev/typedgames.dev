...
código de color que enviemos. Para mi ejemplo utilizaré algunos códigos de 
colores de CSS: *darkblue*, *magenta*, *brown* y *teal*. 

En caso de que el usuario presione una tecla que no está indicada en el código 
anterior, dibujaré el cuadrado de color blanco para aparentar que está 
desapareciendo.
